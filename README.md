...
[![Version](https://img.shields.io/badge/version-0.3.2-orange)](https://github.com/SHANGKAIJIE/zotero-hover-translate-eudic/releases)
...
**开启术语库**：勾选后术语库功能生效，可在**划词模式**下看到「+术语库」按钮，点击即可加入术语库。
...
> 侧边栏面板仅对本地平台内容作展示，仅当「生词本平台」或「同步至本地」选择 本地生词表 / Zotero 笔记 时，或者开启术语库时 可使用。切换相关设置时启用状态**实时更新**，无需取消勾选或重启 Zotero。
