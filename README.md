...
[![Version](https://img.shields.io/badge/version-0.2.1-orange)](https://github.com/SHANGKAIJIE/zotero-hover-translate-eudic/releases)
...
- **一键同步欧路 / 墨墨生词本**：翻译弹窗内点击圆形 `+` 按钮，将当前单词加入云端指定生词本（添加后切换为 `✓` 或 `✗` 状态反馈）。支持**欧路词典**与**墨墨背单词**双平台切换。
