...
declare namespace _ZoteroTypes {
  interface Prefs {
    PluginPrefsMap: {
      ...
      "reciteAutoSpeakWord": boolean;
      "reciteAutoSpeakBefore": boolean;
      "reciteAutoSpeakAfter": boolean;
      "reciteAutoSpeakSentence": boolean;
      "reciteShowSentence": boolean;
      "reciteSentenceSpeakRate": string;
      "reciteSyllableSplit": boolean;
      "reciteOrder": string;
      "reciteAccent": string;
      "reciteSpeakRate": string;
      "reciteMode": string;
      "reciteSentenceSource": string;
      "reciteDictSentenceSource": string;
      "reciteDailyNew": number;
      "reciteDailyLimit": number;
      "reciteDesiredRetention": number;
      "reciteRemind": string;
