...
/**
 * Bootstrap entry. Structure follows the official Zotero 7 bootstrap pattern
 * (Make It Red example) and the zotero-plugin-template.
...
async function startup({ id, version, resourceURI, rootURI }, reason) {
   ...
   * environment and all child variables assigned to it are globally
   * accessible. See `src/index.ts` for details.
   */
  const ctx = {
    rootURI,
  };
